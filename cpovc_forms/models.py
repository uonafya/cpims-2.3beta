...
class OVCHIVManagement(models.Model):
    ...
    MUAC = models.CharField(max_length=20, null=False)
    ...
    Disclosure = models.CharField(max_length=20, null=False)
    MUAC_Score = models.CharField(max_length=20, null=False)
    BMI = models.CharField(max_length=20, null=False)
    Nutritional_Support = models.CharField(max_length=50, null=False)
