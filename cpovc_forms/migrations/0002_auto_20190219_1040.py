...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='ovcgokbursary',
            name='constituency',
            field=models.ForeignKey(related_name='child_constituency', to='cpovc_main.SetupGeography'),
        ),
        migrations.AddField(
            model_name='ovcgokbursary',
            name='county',
            field=models.ForeignKey(related_name='child_county', to='cpovc_main.SetupGeography'),
        ),
        migrations.AddField(
            model_name='ovcgokbursary',
            name='person',
        ...
        migrations.AddField(
            model_name='ovcgokbursary',
            name='school_bank',
            field=models.ForeignKey(to='cpovc_forms.ListBanks'),
        ),
        migrations.AddField(
            model_name='ovcgokbursary',
            name='school_constituency',
            field=models.ForeignKey(related_name='school_constituency', to='cpovc_main.SetupGeography'),
        ),
        migrations.AddField(
            model_name='ovcgokbursary',
            name='school_county',
            field=models.ForeignKey(related_name='school_county', to='cpovc_main.SetupGeography'),
        ),
        migrations.AddField(
