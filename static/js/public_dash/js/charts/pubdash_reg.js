...
//    ouChange('national',"0",'none','none');
   ...
   //--3--
   function fetchWoBCertAtEnrol(org_level,area_id,funding_partner,funding_part_id,period_type){
        var the_url = '/get_total_wout_bcert_at_enrol/'+org_level+'/'+area_id+'/'+funding_partner+'/'+funding_part_id+'/'+period_type+'/';
