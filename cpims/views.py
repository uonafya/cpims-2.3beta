...
from cpovc_registry.functions import dashboard, ovc_dashboard, get_public_dash_ovc_hiv_status, \
    ...
    _get_benchmark_results,_get_per_domain_results,_get_hh_categorization,_get_all_ovcs,_get_household_exits
...
def get_all_ovcs(request, org_level,area_id,funding_partner,funding_part_id,period_type):
    main_dash_data = _get_all_ovcs(org_level, area_id,funding_partner,funding_part_id,period_type)
    return JsonResponse(main_dash_data, content_type='application/json',
                        safe=False)
...
# CPARA
def get_cpara_results(request, org_level,area_id,funding_partner,funding_part_id,period_type):
    main_dash_data = _get_cpara_results(org_level, area_id,funding_partner,funding_part_id,period_type)
    return JsonResponse(main_dash_data, content_type='application/json',
                        safe=False)

# CPARA Per benchmark score
def get_benchmark_results(request, org_level,area_id,funding_partner,funding_part_id,period_type):
    main_dash_data = _get_benchmark_results(org_level, area_id,funding_partner,funding_part_id,period_type)
    return JsonResponse(main_dash_data, content_type='application/json',
                        safe=False)
...
def get_hh_categorization(request, org_level,area_id,funding_partner,funding_part_id,period_type):
    main_dash_data = _get_hh_categorization(org_level, area_id,funding_partner,funding_part_id,period_type)
    return JsonResponse(main_dash_data, content_type='application/json',
                        safe=False)

def get_household_exits(request, org_level,area_id,funding_partner,funding_part_id,period_type):
    main_dash_data = _get_household_exits(org_level, area_id,funding_partner,funding_part_id,period_type)
    return JsonResponse(main_dash_data, content_type='application/json',
                        safe=False)
...
def get_total_wout_bcert_at_enrol(request, org_level,area_id,funding_partner,funding_part_id,period_type):
